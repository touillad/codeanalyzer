...
func (v *Visitor) Visit(node ast.Node) ast.Visitor {
	...
	case *ast.AssignStmt, *ast.BadStmt, *ast.BlockStmt, *ast.BranchStmt, *ast.DeclStmt, *ast.DeferStmt, *ast.EmptyStmt, *ast.ExprStmt, *ast.ForStmt, *ast.GoStmt, *ast.IfStmt, *ast.IncDecStmt, *ast.LabeledStmt, *ast.RangeStmt, *ast.ReturnStmt, *ast.SelectStmt, *ast.SendStmt, *ast.SwitchStmt, *ast.TypeSwitchStmt:
		...
		v.StructInfo[identifier].NumberStmts++
